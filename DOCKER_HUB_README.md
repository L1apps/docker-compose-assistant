...
![Version](https://img.shields.io/badge/version-1.10.2-blue) ![License](https://img.shields.io/badge/license-Apache%202.0-green)
...
*   **📏 Version Aware**: Respects the Docker Compose version (v2, v3, etc.) specified in your file for accurate validation.
